...
import (
	"github.com/carvaee/gokogiri/html"
	"github.com/carvaee/gokogiri/xml"
)
...
found in the github.com/carvaee/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
