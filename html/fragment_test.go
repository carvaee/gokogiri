...
func TestAddFragmentWithNamespace(t *testing.T) {
	...
	defer doc.Free()
	docFragment, err := doc.ParseFragment([]byte("<div xmlns='http://www.carvaee.com' class='cool'><h1>"), nil, DefaultParseOption)
	if err != nil {
		t.Error(err.Error())
		return
	}
	if docFragment.String() != `<div xmlns="http://www.carvaee.com" class="cool"><h1></h1></div>` {
...
<div xmlns="http://www.carvaee.com" class="cool"><h1></h1></div>
</body></html>
` {
